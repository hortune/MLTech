...
cmd = (
        "svm-train -s 0 -t 2 -g 1 -c 0.1 train model_0",
        "svm-train -s 0 -t 2 -g 10 -c 0.1 train model_1",
        "svm-train -s 0 -t 2 -g 100 -c 0.1 train model_2",
        "svm-train -s 0 -t 2 -g 1000 -c 0.1 train model_3",
        "svm-train -s 0 -t 2 -g 10000 -c 0.1 train model_4"
        )
valid = (
